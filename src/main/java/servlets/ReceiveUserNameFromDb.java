...
public class ReceiveUserNameFromDb extends AbstractAppServlet {
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        TableModel nameFromDb = UserRepository.getResults(username,out);
        System.out.println("nameFromDb.getFødt() = " + nameFromDb.getFødt());
        out.print("<h1> Resultater:" + "\n"
                + nameFromDb.getFødt() + "\n"
                + nameFromDb.getKlubb()  + "\n"
                + nameFromDb.getMeter2000());
